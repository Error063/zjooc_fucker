            ...
            for child in chapter['children']:
                ...
                for sub_child in child['children']:
                    ...
                    try:
                        ...
                        if play_progress != 100 and not (sub_child['originalResourceUrl'].endswith(".pdf")):
                            print(session.get('https://www.zjooc.cn/ajax',
                                              params={
                                                  ...
                                                  'params%5BcourseId%5D': course_id,
                                                  'params%5BchapterId%5D': sub_child_id,
                                                  'params%5BplayTime%5D': sub_child['vedioTimeLength'],
                                                  'params%5Bpercent%5D': 100
                                              }, headers={"Signcheck": utils.calculateMd5(),
                                                          "Timedate": str(int(time.time() * 1000))}).text)
                    except:
